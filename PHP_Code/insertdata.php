...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Verify the password
        ...
        $ecgValue = isset($_POST['ecg_value']) ? $_POST['ecg_value'] : null;
        $irValue = isset($_POST['ir_value']) ? $_POST['ir_value'] : null;
        $redValue = isset($_POST['red_value']) ? $_POST['red_value'] : null;  
